# This file was generated automatically. Do not modify it manually. (based on django 748551fea0b4e37231203a063356572a47e09efb)
...
async def _CASCADE(collector, field, sub_objs, using):
    ...
    if (
        field.null
        and not async_connections[using].features.can_defer_constraint_checks
    ):
...
class Collector:
    ...
    def related_objects(self, related_model, related_fields, objs):
        ...
        return related_model._async_base_manager.using(self.using).filter(
            predicate
        )
...
def _resolve_async_on_delete(on_delete):
    handler = _SYNC_TO_ASYNC_ON_DELETE.get(on_delete)
