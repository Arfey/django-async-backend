...
class TestValuesList(AsyncioTestCase):
    ...
    async def test_values_list(self):
        ...
        self.assertEqual(results[0], ("Test1", 1), "First tuple should be ('Test1', 1)")
        self.assertEqual(results[1], ("Test2", 2), "Second tuple should be ('Test2', 2)")
    ...
    async def test_values_list_no_objects(self):
        ...
        self.assertEqual(len(results), 0, "Should return 0 tuples when none exist")
    ...
    async def test_values_list_flat(self):
        ...
        self.assertEqual(len(results), 2, "Should return 2 values in flat mode")
    ...
    async def test_values_list_named(self):
        ...
        self.assertEqual(results[0].value, 1, "First named tuple value should be 1")
        self.assertEqual(
            results[1].name,
            "Test2",
            "Second named tuple name should be 'Test2'",
        )
        self.assertEqual(results[1].value, 2, "Second named tuple value should be 2")
