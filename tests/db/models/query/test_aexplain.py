...
class TestAExplain(AsyncioTestCase):
    async def test_aexplain(self):
        ...
        self.assertIn(
            ...
            explain_output,
            "Explain output should contain 'Seq Scan'",
        )
        self.assertNotIn(
            "Planning Time",
            explain_output,
            "'Planning Time' should not be present in explain output",
        )
        self.assertNotIn(
            "Execution Time",
            explain_output,
            "'Execution Time' should not be present in explain output",
        )
    ...
    async def test_aexplain_with_options(self):
        ...
        self.assertIn(
            "test_model",
            explain_output,
            "Explain output should reference the correct table",
        )
        self.assertIn(
            "Planning Time",
            explain_output,
            "Explain output should contain 'Planning Time'",
        )
        self.assertIn(
            "Execution Time",
            explain_output,
            "Explain output should contain 'Execution Time'",
        )
