...
class TestAnnotate(AsyncioTestCase):
    ...
    async def test_annotate_count(self):
        ...
        self.assertEqual(len(results), 3, "Should return 3 distinct value groups")
        self.assertEqual(results[0]["value"], 1, "First group value should be 1")
        self.assertEqual(results[0]["count"], 1, "First group count should be 1")
        self.assertEqual(results[1]["value"], 2, "Second group value should be 2")
        self.assertEqual(results[1]["count"], 1, "Second group count should be 1")
        self.assertEqual(results[2]["value"], 3, "Third group value should be 3")
        self.assertEqual(results[2]["count"], 1, "Third group count should be 1")
    ...
    async def test_annotate_with_filter(self):
        ...
        self.assertEqual(len(results), 1, "Should return 1 group for filtered value")
